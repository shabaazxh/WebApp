...
namespace WebApp.Server.Migrations
{
    ...
    [Migration("20211128205922_ProjectsMigration4")]
    partial class ProjectsMigration4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Shared.ProjectUsers", b =>
                {
                    b.Property<Guid>("ProjectUsersKey")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebApp.Shared.ProjectUsers", b =>
                {
                    b.HasOne("WebApp.Shared.Project", "Project")
                        .WithMany("AssignedUsersToProject")
                        .HasForeignKey("ProjectID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApp.Shared.ApplicationUser", "Users")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("WebApp.Shared.Project", b =>
                {
                    b.Navigation("AssignedUsersToProject");
                });
